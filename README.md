...
Here is a quick refactoring that I made for the well-known Gilded Rose kata. I've implemented my solution in Java.
It relies heavily on polymorphism. It could certainly be improved, but I find this implementation quite satisfying.
